...
@observer
class BDataStructureContainer extends Component {
    ...
    const handleSaveConfirm = async() =>  {
      ...
      if(id) {
        ...
        if(title && value && preview) {
          await bdatastructureStore.setDatastructureEditorContent({ title, value, preview })
        } else {
...
export default BDataStructureContainer
